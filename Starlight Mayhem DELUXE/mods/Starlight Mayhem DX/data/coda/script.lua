...
if sonidodemierdaputamadrehijosdeperranomerrobenelport == false then
	...
	function onUpdate(elapsed)
		...
		for i = 0, getProperty('unspawnNotes.length')-1 do
			if getPropertyFromGroup('unspawnNotes', i, 'noteType') == '' or getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'codaruby' or getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'codagf' or getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'codaduo' or getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'codaduo2' then

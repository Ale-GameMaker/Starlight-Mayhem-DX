...
function onCreatePost()
    ...
    makeLuaSprite('UpperBar(No HUD)', 'empty', -110, -1250)
	makeGraphic('UpperBar(No HUD)', 1500, 1000, '000000')
	setObjectCamera('UpperBar(No HUD)', 'HUD')
	addLuaSprite('UpperBar(No HUD)', false)

    makeLuaSprite('LowerBar(No HUD)', 'empty', -110, 1720)
	makeGraphic('LowerBar(No HUD)', 1500, 1000, '000000')
